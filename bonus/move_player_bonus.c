...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2224/05/24 17:19:22 by arekoune          #+#    #+#             */
/*   Updated: 2024/05/26 15:23:12 by arekoune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void move_up(t_num *num, int a)
{
	...
	mlx_image_to_window(num->mlx, num->ground, 0, 0);
	mlx_put_string(num->mlx, str, 30, 22);
	free(str);
}
...
{
	if (num->map[num->p_y][num->p_x] != 'E' && num->map[num->p_y][num->p_x] != 'A')
