...
BFILES = bonus/so_long_bonus.c bonus/check_map_bonus.c bonus/check_map_utils_bonus.c bonus/list_utils_bonus.c\
		...
		bonus/get_next_line_bonus.c bonus/get_next_line_utils_bonus.c bonus/animation_bonus.c bonus/get_pointers_bonus.c\
		bonus/enemy_moves_bonus.c bonus/pointers_to_null_bonus.c
